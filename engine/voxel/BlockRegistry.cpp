...
const DefaultBlock kDefaults[blocks::Count] = {
    ...
    {"grass", BlockRender::Opaque, true, false, C(104, 206, 72), C(140, 110, 66), C(140, 92, 56), 0, 0.6f, 3, 1, 0.0f},
    {"sand", BlockRender::Opaque, true, false, C(246, 226, 148), C(236, 214, 136), C(224, 200, 124), 0, 0.5f, 3, 1, 0.0f},
