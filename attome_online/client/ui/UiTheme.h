...
inline constexpr ImU32 PanelTop = IM_COL32(40, 46, 64, 165);   // translucent slate, not black
inline constexpr ImU32 PanelBottom = IM_COL32(24, 28, 40, 190);
inline constexpr ImU32 Border = IM_COL32(236, 214, 170, 48);   // soft warm hairline
